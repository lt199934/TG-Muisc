...
function getSongLists(pageNum) {
    ...
    $.ajax({
        "url": "/songList/page", method: "get", data: data, success: function (data) {
            $("#songLists").empty();
...
function getAlbums(pageNum) {
    ...
    $.ajax({
        "url": "/albums/page", method: "get", data: data, success: function (data) {
            $("#albums").empty();
...
function getSongs(pageNum) {
    ...
    $.ajax({
        "url": "/song/all", method: "get", data: data, success: function (data) {
            $("#songs").empty();
            var songs = data.list;
...
$("#songs").on("click", "#playOne", function () {
    ...
    $.ajax({
        url: "/song/updatePlayCount/" + num, method: "post", success: function (data) {
            console.log(data);
            if (data === 1) {
                console.log("播放量加1");
            }
